...
# 📌 Step 1: Define the LAB Autoencoder Model
...
# 📌 Step 2: Convert Enhanced Image to LAB Channels
...
def generate_dynamic_shares(encrypted_data, img_shape):
    ...
    # 🎯 Convert to int16 before subtraction to avoid overflow
...
# 📌 Step 6: Reconstruct Encrypted Image
...
# 📌 Display Shares for Each LAB Channel
